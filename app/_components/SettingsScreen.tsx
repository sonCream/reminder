    ...
    return (
      <div className="help">
        <section>
          ...
          <p>
            <b>알림을 길게 누르는 방법</b>이 기종을 타지 않습니다.
            받은 알림을 상단바에서 길게 누르면 <b>톱니바퀴(⚙)</b>가 나오고,
            거기서 <b>긴급</b> 또는 <b>알림 팝업</b>을 켜면 됩니다.
          </p>
          <p className="tip">
            문구는 기종마다 다릅니다. <b>팝업</b> · <b>긴급</b> · <b>소리 및 팝업</b> 중 보이는 것을 고르세요.
          </p>
          <p className="tip">
            톱니바퀴가 없으면 설정에서 찾습니다. 경로가 기종마다 달라
            <b> 설정 검색창에 &lsquo;리마인더&rsquo;</b>를 입력하는 편이 빠릅니다.
            채널(보통 <b>일반</b>)을 한 번 더 눌러야 팝업 설정이 나옵니다.
          </p>
